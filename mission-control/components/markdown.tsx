  ...
  return (
    ...
    >
      {blocks.map((b, i) => {
        ...
        if (b.kind === "quote")
          return (
            // Editorial blockquote — bg-overlay + italic + padding suffice for
            // differentiation. No side-tab border (impeccable detect:
            // side-tab rule, "most recognizable tell of AI-generated UIs").
            // FT-style block quotes don't carry coloured side bars.
            <blockquote
              key={k}
              style={{
                fontStyle: "italic",
