  ...
  return (
    ...
    >
      <head suppressHydrationWarning>
        ...
        />
        {/* 3-font system per Phase MM research — split into 3 explicit
            <link> tags so impeccable detect sees each family-loading
            independently (combined URL was being parsed as single-font).
            Sans:    Geist (distinctive, replaces overused Inter)
            Display: Playfair Display (editorial serif register)
            Mono:    JetBrains Mono (data/numbers register) */}
        <link
