# PMLL11 — Pilot Deep Dive (2026-05-10)
...
- Última cotação DB: 2026-05-08 → close=108.54000091552734
- Último fundamentals snapshot: period_end=2026-05-10 · ROE=None · DY=0.09222406408297722 · P/E=217.08
...
|---|---|---|---|
| https://www.fiis.com.br/pmll11/ | ✅ | 32.8s | 15,074 |
...
| Data | Título |
|---|---|
| 30-04-2026 | MXRF11 divulga novo pagamento de dividendos; descubra o valor |
| 30-04-2026 | Mais de 170 fundos imobiliários (FIIs) divulgam dividendos (30); veja valores |
| 30-04-2026 | GGRC11, SNAG11 e dividendos são destaques do Bom Dia FIIs (28/4) |
| 30-04-2026 | GARE11 divulga dividendos com yield próximo de 1%; veja valor e detalhes |
...
### 1. 30-04-2026 — MXRF11 divulga novo pagamento de dividendos; descubra o valor

URL: https://fiis.com.br/noticias/fundo-imobiliario-mxrf11-divulga-novo-pagamento-dividendos-maio-2026-jj/
...
### 2. 30-04-2026 — Mais de 170 fundos imobiliários (FIIs) divulgam dividendos (30); veja valores
...
### 3. 30-04-2026 — GGRC11, SNAG11 e dividendos são destaques do Bom Dia FIIs (28/4)

URL: https://fiis.com.br/noticias/bom-dia-fiis-280426/
Após data máxima DB: **SIM (após max DB date)**
...
### 4. 30-04-2026 — GARE11 divulga dividendos com yield próximo de 1%; veja valor e detalhes
...
- 🚨 **30-04-2026** matched `dividend` → Dividend declaration: _MXRF11 divulga novo pagamento de dividendos; descubra o valor_
...
- 🚨 **30-04-2026** matched `dividend` → Dividend declaration: _GGRC11, SNAG11 e dividendos são destaques do Bom Dia FIIs (28/4)_
- 🚨 **30-04-2026** matched `dividend` → Dividend declaration: _GARE11 divulga dividendos com yield próximo de 1%; veja valor e detalhes_
