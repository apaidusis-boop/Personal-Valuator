# NWN — Pilot Deep Dive (2026-05-10)

- **Market**: US
- **Sector**: Utilities
- **RI URLs scraped** (1):
  - https://investor.northwestnatural.com/
...
- Última cotação DB: 2026-05-08 → close=50.439998626708984
- Último fundamentals snapshot: period_end=2026-05-10 · ROE=0.08103 · DY=0.039036480047748755 · P/E=17.273972
...
- Scrape: ✅ **1/1 URLs OK** · total 6.1s

| URL | OK | Time | MD chars |
|---|---|---|---|
| https://investor.northwestnatural.com/ | ✅ | 6.1s | 91 |
