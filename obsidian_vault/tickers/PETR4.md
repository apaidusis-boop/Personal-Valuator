...
- `2026-04-22` **Virtual Asset** — [risk conf=0.80] A Petrobras reconhece que as tensões geopolíticas podem impactar negativamente seus resultados.
- `2026-04-22` **Virtual Asset** — [risk conf=0.80] A Petrobras alerta que a adaptação à nova legislação tributária pode causar efeitos adversos nos resultados.
- `2026-04-22` **Virtual Asset** — [guidance conf=0.70] A Petrobras confirmou a distribuição de R$8 bilhões em dividendos e reforçou a distribuição total de R$41,2 bilhões em 2025.
- `2026-04-21` **Market Makers** — [valuation conf=0.70] A Petrobras é considerada razoavelmente barata em vários cenários diferentes.
- `2026-04-21` **Market Makers** — [operational conf=0.80] A Petrobras pode gerar um excedente de ordem de grandeza de 15 bilhões de dólares devido à variação do preço do petróleo.
...
| 2022-12-31 | R$124.47B | R$69.93B | R$36.62B |
| 2023-12-31 | R$102.41B | R$52.29B | R$24.88B |
| 2024-12-31 | R$91.42B | R$27.46B | R$7.53B |
| 2025-12-31 | R$89.19B | R$46.04B | R$19.63B |
...
series:
  - title: Dividends
    data: [0.9166, 0.9424, 0.0005, 5.6532, 15.1664, 7.3443, 7.9311, 3.2813, 0.6525]
width: 80%
beginAtZero: false
fill: false
tension: 0.3
