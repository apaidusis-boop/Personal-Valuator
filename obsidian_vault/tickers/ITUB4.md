...
- `2026-04-21` **Market Makers** — [valuation conf=0.80] O Itaú é avaliado mais caro que o Bradesco, com múltiplo de P/L em torno de nove vezes, enquanto o Bradesco está em sete vezes.
- `2026-04-21` **Market Makers** — [thesis_bear conf=0.70] O Itaú é considerado mais caro em comparação com o Bradesco, sugerindo que há espaço para compressão da disparidade de valuation.
- `2026-04-21` **Virtual Asset** — [dividend conf=0.70] É possível comprar ações ITUB4 por um preço abaixo do desejado e receber um prêmio adicional.
- `2026-04-07` **Virtual Asset** — [risk conf=0.70] Riscos incluem dependência do Itaú e atraso ou falha em mudanças tributárias.
- `2026-04-07` **Virtual Asset** — [risk conf=0.60] A dependência do Itaú e a necessidade de mudanças tributárias podem afetar o desconto de holding da Itaúsa.
...
series:
  - title: Dividends
    data: [0.9387, 0.882, 1.8803, 2.4753, 1.1505, 0.8003, 0.8986, 1.1091, 2.13, 4.4493, 0.4216]
width: 80%
beginAtZero: false
fill: false
tension: 0.3
