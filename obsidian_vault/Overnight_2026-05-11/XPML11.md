# XPML11 — Pilot Deep Dive (2026-05-10)
...
- Última cotação DB: 2026-05-08 → close=109.7300033569336
- Último fundamentals snapshot: period_end=2026-05-10 · ROE=None · DY=0.10059746343115826 · P/E=None
...
- Scrape: ✅ **1/1 URLs OK** · total 35.2s

| URL | OK | Time | MD chars |
|---|---|---|---|
| https://www.fiis.com.br/xpml11/ | ✅ | 35.2s | 12,825 |
...
|---|---|---|---|
| Filings na DB | 1 | 1 + 0 novos no RI | = |
