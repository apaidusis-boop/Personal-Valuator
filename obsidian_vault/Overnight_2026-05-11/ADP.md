# ADP — Pilot Deep Dive (2026-05-10)

- **Market**: US
- **Sector**: Industrials
- **RI URLs scraped** (1):
  - https://www.automaticdataprocessing.com/investors
...
- Última cotação DB: 2026-05-08 → close=213.0
- Último fundamentals snapshot: period_end=2026-05-10 · ROE=0.71208 · DY=0.030422535211267608 · P/E=19.887487
...
- Scrape: ✅ **1/1 URLs OK** · total 3.2s

| URL | OK | Time | MD chars |
|---|---|---|---|
| https://www.automaticdataprocessing.com/investors | ✅ | 3.2s | 267 |
