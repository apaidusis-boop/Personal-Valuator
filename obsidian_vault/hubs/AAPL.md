...
_source: `Overnight_2026-05-13\AAPL.md` (now in cemetery)_
...
_source: `agents\Charlie Compounder\reviews\AAPL_2026-04-30.md` (now in cemetery)_
...
_source: `agents\Mariana Macro\reviews\AAPL_2026-04-30.md` (now in cemetery)_
...
_source: `agents\Pedro Alocação\reviews\AAPL_2026-04-30.md` (now in cemetery)_
...
_source: `agents\Valentina Prudente\reviews\AAPL_2026-04-30.md` (now in cemetery)_
...
#### — · DRIP scenarios
_source: `briefings\drip_scenarios\AAPL_drip.md` (now in cemetery)_
...
#### — · Council aggregate
_source: `dossiers\AAPL_COUNCIL.md` (now in cemetery)_
...
_… (truncated at 15k chars — full content in cemetery copy of `dossiers\AAPL_COUNCIL.md`)_

#### — · Story
_source: `dossiers\AAPL_STORY.md` (now in cemetery)_
...
_… (truncated at 15k chars — full content in cemetery copy of `dossiers\AAPL_STORY.md`)_

#### — · Other
_source: `hubs\AAPL.md` (now in cemetery)_

#### AAPL — Apple

> **Hub consolidado**. Tudo o que existe no vault sobre AAPL, em ordem cronológica. Cada link aponta para o ficheiro original que ficou na sua pasta — esta é a porta de entrada matinal.
...
- **2026-05-13** · Overnight → [[AAPL]] _(`Overnight_2026-05-13/AAPL.md`)_
- **2026-05-11** · Overnight → [[AAPL]] _(`Overnight_2026-05-11/AAPL.md`)_
- **2026-04-30** · Earnings Prep → [[earnings_prep_AAPL_2026-04-30]] _(`briefings/earnings_prep_AAPL_2026-04-30.md`)_
- **2026-04-30** · Dossier Archive → [[AAPL_STORY_2026-04-30]] _(`dossiers/archive/AAPL_STORY_2026-04-30.md`)_
- **2026-04-30** · Review · Valentina Prudente → [[AAPL_2026-04-30]] _(`agents/Valentina Prudente/reviews/AAPL_2026-04-30.md`)_
- **2026-04-30** · Review · Pedro Alocação → [[AAPL_2026-04-30]] _(`agents/Pedro Alocação/reviews/AAPL_2026-04-30.md`)_
- **2026-04-30** · Review · Mariana Macro → [[AAPL_2026-04-30]] _(`agents/Mariana Macro/reviews/AAPL_2026-04-30.md`)_
- **2026-04-30** · Review · Charlie Compounder → [[AAPL_2026-04-30]] _(`agents/Charlie Compounder/reviews/AAPL_2026-04-30.md`)_
- **2026-04-24** · Other → [[apply_tech_aapl]] _(`briefings/overnight_research_2026-04-24/apply_tech_aapl.md`)_

###### (undated)

- **—** · Wiki → [[AAPL]] _(`wiki/holdings/AAPL.md`)_
- **—** · Variant → [[AAPL_VARIANT]] _(`tickers/AAPL_VARIANT.md`)_
- **—** · Story → [[AAPL_STORY]] _(`dossiers/AAPL_STORY.md`)_
- **—** · Panorama → [[AAPL]] _(`tickers/AAPL.md`)_
- **—** · Other → [[AAPL]] _(`hubs/AAPL.md`)_
- **—** · Ic Debate → [[AAPL_IC_DEBATE]] _(`tickers/AAPL_IC_DEBATE.md`)_
- **—** · Drip → [[AAPL_drip]] _(`briefings/drip_scenarios/AAPL_drip.md`)_
- **—** · Deepdive → [[AAPL_DOSSIE]] _(`tickers/AAPL_DOSSIE.md`)_
- **—** · Council → [[AAPL_COUNCIL]] _(`dossiers/AAPL_COUNCIL.md`)_

##### 🗂️ Artefactos por categoria

###### Panorama
- [[AAPL]] _(`tickers/AAPL.md`)_

###### Deepdive (DOSSIE)
- [[AAPL_DOSSIE]] _(`tickers/AAPL_DOSSIE.md`)_

###### Story
- [[AAPL_STORY]] _(`dossiers/AAPL_STORY.md`)_

###### Council aggregate
- [[AAPL_COUNCIL]] _(`dossiers/AAPL_COUNCIL.md`)_

###### Council reviews por persona

_Charlie Compounder_:
- [[AAPL_2026-04-30]] _(`agents/Charlie Compounder/reviews/AAPL_2026-04-30.md`)_

_Mariana Macro_:
- [[AAPL_2026-04-30]] _(`agents/Mariana Macro/reviews/AAPL_2026-04-30.md`)_

_Pedro Alocação_:
- [[AAPL_2026-04-30]] _(`agents/Pedro Alocação/reviews/AAPL_2026-04-30.md`)_

_Valentina Prudente_:
- [[AAPL_2026-04-30]] _(`agents/Valentina Prudente/reviews/AAPL_2026-04-30.md`)_

###### IC Debate (synthetic)
- [[AAPL_IC_DEBATE]] _(`tickers/AAPL_IC_DEBATE.md`)_

###### Variant perception
- [[AAPL_VARIANT]] _(`tickers/AAPL_VARIANT.md`)_

###### Overnight scrapes
- [[AAPL]] _(`Overnight_2026-05-13/AAPL.md`)_
- [[AAPL]] _(`Overnight_2026-05-11/AAPL.md`)_

###### DRIP scenarios
- [[AAPL_drip]] _(`briefings/drip_scenarios/AAPL_drip.md`)_

###### Earnings prep briefs
- [[earnings_prep_AAPL_2026-04-30]] _(`briefings/earnings_prep_AAPL_2026-04-30.md`)_

###### Wiki / playbooks
- [[AAPL]] _(`wiki/holdings/AAPL.md`)_

###### Archived stories
- [[AAPL_STORY_2026-04-30]] _(`dossiers/archive/AAPL_STORY_2026-04-30.md`)_

###### Other
- [[apply_tech_aapl]] _(`briefings/overnight_research_2026-04-24/apply_tech_aapl.md`)_
- [[AAPL]] _(`hubs/AAPL.md`)_

##### ⚙️ Refresh commands

```bash
ii panorama AAPL --write       # aggregator (verdict+peers+notes+videos)
ii deepdive AAPL --save-obsidian # V10 4-layer pipeline
ii verdict AAPL --narrate --write
ii fv AAPL                      # fair value (Buffett-Graham conservative)
python -m analytics.fair_value_forward --ticker AAPL # quality-aware forward
```
...
#### — · Panorama
_source: `tickers\AAPL.md` (now in cemetery)_
...
#### — · Deepdive (DOSSIE)
_source: `tickers\AAPL_DOSSIE.md` (now in cemetery)_
...
#### — · IC Debate (synthetic)
_source: `tickers\AAPL_IC_DEBATE.md` (now in cemetery)_
...
#### — · Variant perception
_source: `tickers\AAPL_VARIANT.md` (now in cemetery)_
...
#### — · Wiki playbook
_source: `wiki\holdings\AAPL.md` (now in cemetery)_
