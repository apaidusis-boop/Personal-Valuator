...
- **Fundamentals** (2026-05-13): P/E 6.50 · P/B 1.11 · DY 11.3% · ROE 17.0% · ND/EBITDA 2.35 · Dividend streak 17
...
_source: `Overnight_2026-05-13\CMIG4.md` (now in cemetery)_
...
#### — · Panorama
_source: `tickers\CMIG4.md` (now in cemetery)_
...
|---|---|---|---:|---|
| 2026-05-13 | Virtual Asset | dividend | 0.90 | A CEMIG apresenta um dividendo yield de 10,78%, o que a torna uma excelente opção para investidores interessados em dividendos sintéticos. |
| 2026-05-13 | Virtual Asset | management | 0.90 | A CEMIG anunciou a troca do CEO, com Alexandre Ramos Peixoto substituindo Reinaldo Passanese Filho. |
| 2026-05-13 | Virtual Asset | balance_sheet | 0.80 | O resultado operacional (EBITDA) da CEMIG no primeiro trimestre de 2026 foi de R$1,79 bilhão, representando uma queda de 2,1% em relação ao… |
| 2026-05-13 | Virtual Asset | risk | 0.80 | A pressão nas margens é um risco significativo para a CEMIG, pois se os custos crescerem mais rápido que as receitas, o lucro pode ser impa… |
| 2026-05-13 | Virtual Asset | valuation | 0.80 | As ações da CEMIG (CMIG4) estão sendo negociadas com um PVP de 17% acima do valor patrimonial, indicando que o mercado está avaliando posit… |
...
#### — · IC Debate (synthetic)
_source: `tickers\CMIG4_IC_DEBATE.md` (now in cemetery)_

#### 🏛️ Synthetic IC Debate — CMIG4
...
**Rationale**:
- ROE alto e estável
- Preço atrativo com PE baixo
- Dividend yield atraente

**Key risk**: Exposição à volatilidade do setor de energia elétrica no Brasil
...
- ROE forte
- Net debt/EBITDA razoável

**Key risk**: Dependência de juros e liquidez macroeconômica

###### 🟢 Nassim Taleb — **BUY** (conv 8/10, size: medium)

**Rationale**:
- DY de 10,78% atrativo
- ROE forte de 17,51%
- Nível de dívida controlado

**Key risk**: Potencial volatilidade do setor elétrico brasileiro

###### 🟢 Seth Klarman — **BUY** (conv 8/10, size: medium)

**Rationale**:
- PE e PB baixos indicam desconto
- ROE forte sugere eficiência operacional
- DY atrativo

**Key risk**: Riscos regulatórios e econômicos podem afetar a indústria de energia
...
**Key risk**: Sensibilidade à dívida pública e condições macroeconômicas do Brasil
...
FUNDAMENTALS LATEST:
  ...
  dy: 10.78%
  roe: 17.51%
  net_debt_ebitda: 2.195921674836936
  intangible_pct_assets: 27.7%   (goodwill $0.0B + intangibles $18.5B)
```
...
```bash
ii panorama CMIG4 --write
ii deepdive CMIG4 --save-obsidian
ii verdict CMIG4 --narrate --write
ii fv CMIG4
python -m analytics.fair_value_forward --ticker CMIG4
```
